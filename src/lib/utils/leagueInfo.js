/*   STEP 1   */
export const leagueID = "784492665680076800"; // your league ID
export const leagueName = "The Trailer Park Dynasty"; // your league name
...
export const managers = [
    {
      ...
      "rival": {
        name: "Chadwick", // Can be anything (usually your rival's name)
      ...
      "philosophy": "Blowing it up, every other week",
    ...
    },
    {
      ...
      "name": "Caleb Hensley",
      "tookOver": 2021, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Beckley, WV", // (optional)
      "bio": "Ramble'n Gamble'n",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": null, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "ny", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      ...
      "philosophy": "Blow it up, or win it all.",
      "tradingScale": 10, // 1 - 10
      "preferredContact": "Discord", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
      ...
      "name": "Nate",
      "tookOver": 2021, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Logan, WV", // (optional)
      "bio": "New, but ain't a newbie",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": null, // (optional) when did the manager start playing fantasy football
